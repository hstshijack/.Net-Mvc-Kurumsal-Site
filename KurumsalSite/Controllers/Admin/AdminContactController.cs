...
namespace KurumsalSite.Controllers.Admin
{
    public class AdminContactController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Address,Phone,Fax,Whatsapp,Facebook,Twitter,Instagram")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Address,Phone,Fax,Whatsapp,Facebook,Twitter,Instagram")] Contact contact)
        {
            if (ModelState.IsValid)
            {
